...
# Source files
SRC = autonomous_vehicle.c pid.c devices.c control.c init.c

# Object files (corresponding .o files for the source files)
OBJ = build/release/autonomous_vehicle.o build/release/pid.o build/release/devices.o build/release/control.o build/release/init.o
